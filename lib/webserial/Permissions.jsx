    ...
    return <div
        ...
        <div className="ws-relative ws-grid ws-place-items-center ws-h-screen ws-text-black dark:ws-text-white">
            <div className="ws-w-full ws-max-w-xl ws-mx-auto ws-text-center ws-p-4">
                <h4 className="ws-text-xl sm:ws-text-3xl ws-font-semibold ws-uppercase ws-mb-6">Webserial permission request</h4>

                <div role="alert" className="ws-rounded-md ws-bg-gray-50 dark:ws-bg-neutral-900 ws-border-b-4 ws-border-sky-400 dark:ws-border-sky-600 ws-p-4">
                    <div className="ws-flex">
                        <div className="ws-flex-shrink-0">
                            <svg className="ws-size-6 ws-text-gray-700 dark:ws-text-blue-100" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="ws-ml-3 ws-flex-1 ws-text-left">
                            <p className="ws-text-base ws-font-bold ws-text-gray-800 dark:ws-text-white">Note</p>
