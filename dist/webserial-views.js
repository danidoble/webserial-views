...
function P_() {
  ...
  return /* @__PURE__ */ Ve.jsx(Ve.Fragment, { children: /* @__PURE__ */ Ve.jsx("div", { className: "fixed z-[60] bottom-4 right-4 grid gap-2", children: _.map((y, ye) => /* @__PURE__ */ Ve.jsx(OT, { message: y.message, type: y.type }, ye)) }) });
}
OT.propTypes = {
  message: RT.string,
  type: RT.string
